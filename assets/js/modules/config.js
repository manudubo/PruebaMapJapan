// Japan Itinerary - Configuration & Data
...
export const MAPS_URLS = {
  ...
  "Hanazono Shrine": "https://maps.app.goo.gl/51qUuoaWtjyHhjZJC9",
...
export const ITINERARY = {
  tokyo: {
    ...
    days: {
      "2026-02-22": { label: "Dom 22", color: "#ff3b30", activities: [
      ...
      "2026-02-23": { label: "Lun 23", color: "#ff9500", activities: [
      ...
      "2026-02-24": { label: "Mar 24", color: "#ffcc00", activities: [
      ...
      "2026-02-25": { label: "Mié 25", color: "#34c759", activities: [
      ...
      "2026-02-26": { label: "Jue 26", color: "#5ac8fa", activities: [
      ...
      "2026-02-27": { label: "Vie 27", color: "#007aff", activities: [
      ...
      "2026-02-28": { label: "Sáb 28", color: "#af52de", activities: [
      ...
      "2026-03-01": { label: "Dom 1", color: "#ff2d55", activities: [
  ...
  nagoya: {
    name: "Nagoya", center: [35.1700, 136.9000], zoom: 11,
    hotel: { name: "Hotel Trusty Nagoya Shirakawa", coords: [35.1658, 136.8987] },
    dates: "2–3 Mar 2026",
    days: {
      "2026-03-02": { label: "Lun 2", color: "#34c759", activities: [
      ...
      "2026-03-03": { label: "Mar 3", color: "#007aff", activities: [
        { name: "Explorar Nagoya", coords: [35.1706, 136.8816], notes: "Día libre", isGeneric: true }
      ]}
    }
  },
  takayama: {
    name: "Takayama", center: [36.1400, 137.2500], zoom: 10,
    hotel: { name: "Amanek Takayama Hotel", coords: [36.1390, 137.2527] },
    dates: "4–7 Mar 2026",
    days: {
      "2026-03-04": { label: "Mié 4", color: "#ff3b30", activities: [
      ...
      "2026-03-05": { label: "Jue 5", color: "#34c759", activities: [
        { name: "Shirakawa-go", coords: [36.2569, 136.9067], notes: "Bus info: nouhibus.co.jp" }
      ]},
      "2026-03-06": { label: "Vie 6", color: "#007aff", hasOptions: true, activities: [
      ...
      "2026-03-07": { label: "Sáb 7", color: "#af52de", hasOptions: true, activities: [
  ...
  kyoto: {
    name: "Kyoto", center: [35.0000, 135.7600], zoom: 12,
    hotel: { name: "Hotel Amanek Kyoto Kawaramachi Gojo", coords: [34.9968, 135.7665] },
    dates: "8–13 Mar 2026",
    days: {
      "2026-03-08": { label: "Dom 8", color: "#ff3b30", activities: [
      ...
      "2026-03-09": { label: "Lun 9", color: "#ff9500", activities: [
      ...
      "2026-03-10": { label: "Mar 10", color: "#ffcc00", activities: [
        { name: "Día libre", coords: [35.0000, 135.7600], notes: "A definir", isGeneric: true }
      ]},
      "2026-03-11": { label: "Mié 11", color: "#34c759", activities: [
      ...
      "2026-03-12": { label: "Jue 12", color: "#5ac8fa", activities: [
      ...
      "2026-03-13": { label: "Vie 13", color: "#af52de", activities: [
  ...
  osaka: {
    ...
    days: {
      ...
      "2026-03-15": { label: "Dom 15", color: "#34c759", activities: [
      ...
      "2026-03-16": { label: "Lun 16", color: "#007aff", activities: [
        { name: "Universal Studios Japan", coords: [34.6654, 135.4323], notes: "Día completo · Reserva confirmada" }
      ]},
      "2026-03-17": { label: "Mar 17", color: "#af52de", hasOptions: true, activities: [
  ...
  naoshima: {
    name: "Naoshima", center: [34.4600, 133.9950], zoom: 13,
    hotel: { name: "UNO Hotel", coords: [34.4893, 133.9496] },
    dates: "18–19 Mar 2026",
    days: {
      "2026-03-18": { label: "Mié 18", color: "#ff3b30", activities: [
        { name: "Check-in UNO Hotel", coords: [34.4893, 133.9496], notes: null }
      ]},
      "2026-03-19": { label: "Jue 19", color: "#34c759", activities: [
