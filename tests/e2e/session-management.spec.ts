...
// rather than a fixed delay. global-setup pre-handles the first-ever occurrence so this
// path is hit rarely, but subsequent test-run cycles can also trigger it.
