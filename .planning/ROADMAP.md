...
- [x] 09-05-PLAN.md — Wave 3: auth.spec.ts real-auth migration + CI SKIP_REAL_AUTH env (E2E-01)
- [x] 09-06-PLAN.md — Wave 4: passkeys.spec.ts — CDP Virtual Authenticator register/login/delete (E2E-03)
- [x] 09-07-PLAN.md — Wave 4: otp.spec.ts — serial Mailpit OTP tests (request, expired, lockout, UPDATE_PASSWORD gate) (E2E-04)
