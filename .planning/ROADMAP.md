...
| 9. Playwright Real Auth | 0/7 | Ready to execute | - |
...
- [ ] 09-06-PLAN.md — Wave 3: passkeys.spec.ts — CDP Virtual Authenticator register/login/delete (E2E-03)
- [ ] 09-07-PLAN.md — Wave 3: otp.spec.ts — serial Mailpit OTP tests (request, expired, lockout, UPDATE_PASSWORD gate) (E2E-04)
